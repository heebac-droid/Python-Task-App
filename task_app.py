...
def clicking():
    ...
    text_label.configure(text = user_result)
...
user_input = Entry(screen, width=15)
user_input.grid(column=1,row=2)



# Button Definitions
button1 = Button(screen, text="Click me please 🤓", fg="blue",command=clicking, width=18, height=6, font=button_font)
